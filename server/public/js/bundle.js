    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', _context.t0.respones.data.message);
        case 11:
        case "end":
...
if (mapBox) {
  var _locations = JSON.parse(document.getElementById('map').dataset.locations);
}
if (loginForm) {
  loginFormaddEventListener('submit', function (e) {
    e.preventDefault();
